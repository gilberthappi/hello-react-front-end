 ...
 **hello-react-front-end**  In this exercise, I will connect previous knowledge with new knowledge and use Webpack with React redux
...
```
$ git clone https://github.com/gilberthappi/hello-react-front-end.git
```
